    ...
    rows = [
        {
            ...
            "presence_mairie": i.presence_mairie if i.presence_mairie else None,
            "presence_reception": i.presence_reception if i.presence_reception else None,
            "presence_after": i.presence_after if i.presence_after else None,
            ...
            "mode_transport": i.mode_transport if i.mode_transport else "pas_concerne",
            "covoiturage_possible": i.covoiturage_possible if i.covoiturage_possible else None,
            "navette_souhaitee": i.navette_souhaitee if i.navette_souhaitee else None,
            "logement": i.logement if i.logement else "pas_concerne",
            "consomme_alcool": i.consomme_alcool if i.consomme_alcool else "sans_reponse",
            "restriction_alimentaire": i.restriction_alimentaire if i.restriction_alimentaire else "aucune",
